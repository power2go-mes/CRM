...
const LeadList = () => { const role = useLeadRole(); const filters = role === "bdo" ? [<SelectInput key="status" source="status" label="My Lead Status" choices={statuses} emptyText="All My Leads" helperText={false} />] : undefined; return <List title="Leads" actions={<LeadListActions />} filters={filters}><DataTable<Lead> rowClick={role === "bdo" ? "show" : canEditLead(role) ? "edit" : "show"} bulkActionButtons={false}><DataTable.Col source="first_name" label="Name" /><DataTable.Col source="company_name" label="Company" /><DataTable.Col source="email" /><DataTable.Col source="phone" /><DataTable.Col source="source" /><DataTable.Col source="status" /><DataTable.Col source="owner_name" label="Owner" /><DataTable.Col source="assigned_bdo_name" label="Assigned BDO" /><DataTable.Col source="region_name" label="Region" /><DataTable.Col source="converted_at" label="Conversion Status" /></DataTable></List>; };
